...
@section('content')
        ...
        <section class="section z-depth-1 center" style="margin-bottom: 10px;">            
            ...
            <form action="" method="POST" id="">
                ...
                <div class="col s12 right-align" style="padding-bottom: 10px; margin: 0;">
                    ...
                    <button class="btn waves-effect waves-light lighten-1 resp-btn colCode" type="submit" data-act="" id="" data-id="{{ $school->id }}">
                        Save Changes
                    </button>
                </div>
        ...
        <section class="section center z-depth-1" id="resumeSection">
        ...
        <section class="section z-depth-1 center" style="margin-bottom: 10px;" id="sessionChgSection">
